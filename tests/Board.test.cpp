    ...
    SECTION("Board generate moves") {
        std::vector<std::pair<std::string, std::unordered_set<std::string>>> testCases = {
                ...
                {"1n1b1n2/N1k5/p1NRPq1p/p1pPP1r1/3p1pQp/K2P2P1/bRP1PPBp/2r1B3 b - - 0 1",
                 {"A2B1", "A2B3", "A2C4", "A2D5", "D8E7", "C1A1", "C1B1", "C1D1", "C1E1", "C1C2", "G5G4", "G5E5", "G5F5", "G5H5", "G5G6", "G5G7", "G5G8", "F6E5", "F6F5", "F6E6", "F6G6", "F6E7", "F6F7", "F6G7", "F6H8", "B8C6", "B8D7", "F8E6", "F8G6", "F8D7", "F8H7", "H2H1", "F4F3", "H4H3", "A5A4",
                  "C5C4", "H6H5", "H4G3", "F4G3"}},
